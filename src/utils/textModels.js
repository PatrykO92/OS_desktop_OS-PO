const textModel = {
  en: {
    ...
    chooseLanguage: "Choose language (English recommended)",
    ...
    step4: "Click right mouse button on desktop, to open context menu.",
    submit: "Submit",
    success: "Success.",
    name: "Name",
    lastName: "Last name",
  ...
  pl: {
    ...
    changePIN: "Zmień PIN",
    chooseLanguage: "Wybierz język (angielski rekomendowany)",
    close: "Zamknij",
    ...
    refresh: "Odśwież",
    remove: "Usuń",
    repeatPIN: "Powtórz nowy PIN",
    submit: "Potwierdź",
    reset: "Uruchom ponownie",
    samePIN: "PIN-y nie są zgodne. Proszę wprowadź ten sam PIN w oba pola",
    ...
    weatherError2: "Błąd pozyskiwania lokalizacji.",
    weatherError3: "Błąd pozyskiwania pogody.",
    webBrowserInfo:
    ...
    wrongOldPIN: "Stary PIN niepoprawny",
