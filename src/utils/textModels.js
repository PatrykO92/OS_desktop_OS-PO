const textModel = {
  en: {
    ...
    startScreenText2:
      "This is the initial form of the app. You can log in using the guest user, create a new user, or log in to your own user account, if you already have one! Have fun!",
    startScreenText3: "Create user",
    startScreenText4: "Please provide email and password.",
    submit: "Submit",
    email: "Email",
  ...
  pl: {
    ...
    startScreenText2:
      "To jest formularz początkowy aplikacji. Możesz się zalogować używając konta gościa, utworzyć nowe konto użytkownika lub zalogować się na swoje własne konto użytkownika, jeśli już je posiadasz! Baw się dobrze!",
    startScreenText3: "Stwórz użytkownika",
    startScreenText4: "Proszę podać email oraz hasło.",
    email: "Email",
